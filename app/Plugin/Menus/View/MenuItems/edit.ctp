...
<?php echo $this->FormExtended->create('MenuItem', array('edit')); ?>

<!-- Cabecera -->
<div class="inner-header">
	<div class="title"><?php echo $this->Html->image('/platform/img/icons/big/menu.png', array('alt' => __d('platform', 'Edit Item', true), 'align' => 'top')); ?> <?php echo __d('platform', 'Edit Item') ?></div>
...
<?php echo $this->Sidebars->openHelpSidebar(450) ?>
	...
	<?php echo $this->CollapsibleBlocks->block(__d('platform', 'Short Codes', true), $this->element('help/menu-index', array('plugin' => 'platform'))) ?>
...
<?php echo $this->FormExtended->input('id', array('type' => 'hidden')); ?>
