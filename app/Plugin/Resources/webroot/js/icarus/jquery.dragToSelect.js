...
jQuery.fn.dragToSelect = function (conf) {
	...
	var parentOffset	= parent.parent().parent().parent().offset();
	var parentDim		= {
	...
	var showSelectBox = function (e) {
		...
		selectBoxOrigin.left	= e.pageX - parentDim.left + parent.parent().parent()[0].scrollLeft;
		selectBoxOrigin.top		= e.pageY - parentDim.top + parent.parent().parent()[0].scrollTop;
